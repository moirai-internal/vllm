...
if __name__ == "__main__":
    ...
    print(vllm_subcommands)
    print(bench_subcommands)
    ...
    print(option_value_map)

    render_bash_template(template_path="vllm-completion.template.bash",
                         output_path="vllm-completion.bash",
                         replacements={
                             "{{ subcommands }}":
                             vllm_subcommands,
                             "{{ bench_subcommands }}":
