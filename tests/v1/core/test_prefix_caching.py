...
def test_prefill(hash_algo):
    ...
    computed_blocks, _, num_computed_tokens = manager.get_computed_blocks(req0)
    ...
    computed_blocks, _, num_computed_tokens = manager.get_computed_blocks(req1)
    ...
    computed_blocks, _, num_computed_tokens = manager.get_computed_blocks(req2)
    ...
    computed_blocks, _, num_computed_tokens = manager.get_computed_blocks(req3)
    assert not computed_blocks
    assert num_computed_tokens == 0
...
def test_hash_block_correct_reuse():
    ...
    computed_blocks, _, num_computed_tokens = manager.get_computed_blocks(req)
    assert not computed_blocks
    assert num_computed_tokens == 0
